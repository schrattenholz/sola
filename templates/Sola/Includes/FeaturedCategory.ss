        ...
        <div class="col-md-5">
          <div class="d-flex flex-column h-100 overflow-hidden rounded-lg" style="background-color: #e2e9ef;">
            <div class="d-flex justify-content-between px-grid-gutter py-grid-gutter">
              <div>
                <h3 class="bg-light p-1 mb-1">$Headline</h3><a class="font-size-md bg-light p-1 mb-1" href="shop-grid-ls.html">$SubHead<i class="czi-arrow-right font-size-xs align-middle ml-1"></i></a>
              </div>
