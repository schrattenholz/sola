    ...
    <!-- items use Bootstrap .col- classes -->
 			<% if $Children.Filter("ClassName","Schrattenholz\\Order\\ProductList") || $Children.Filter("ClassName","Schrattenholz\\Order\\Product")  %>
				...
				<!-- Catogory-->
				<div class="masonry-item col-md-4 col-sm-6 mb-3">
				...
				<% if not $Top.HideLabel %>
					...
					<% end_if %>
				<% end_if %>
				<a class="d-block overflow-hidden " href="$Link">
					<img class="card-img" src="$DefaultImage.ScaleWidth(400).URL" height="$DefaultImage.ScaleWidth(400).GetHeight" alt="$DefaultImage.Filename">
				</a>
					<div class="card-body">
