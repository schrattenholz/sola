    <header class=" navbar-sticky 	navbar navbar-expand-lg bg-light ">
      <div class="container">
	 
	  <a class="navbar-brand d-none d-sm-block mr-3 order-lg-1" href="{$BaseHref}home" style="min-width: 7rem;"><img src="$OrderConfig.Logo.URL" alt="$SiteConfig.BusinessName"/></a>
	  <a class="navbar-brand d-sm-none mr-2" href="{$BaseHref}home" style="min-width: 4.625rem;"><img style="max-width:140px;" src="$OrderConfig.Logo.URL" alt="$SiteConfig.BusinessName"/></a>
        ...
        <div class="justify-content-end collapse navbar-collapse mr-auto order-lg-2" id="navbarCollapse">
